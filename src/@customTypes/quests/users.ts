...
type CP = Omit<UserQuestProps, "id" | "is_deleted" | "created_at" | "updated_at">;
...
export type UserQuestParams = { user_tag: string; quest_id?: number | number[]; is_daily_quest?: boolean; };